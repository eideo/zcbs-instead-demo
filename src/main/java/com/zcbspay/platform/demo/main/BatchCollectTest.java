...
import com.zcbspay.platform.demo.bean.BatchCollectReqBean;
...
public class BatchCollectTest {
	...
	public static void main(String[] args) {
		BatchCollectReqBean ReqBean = getEmulationData();
		//加密加签
	...
	private static BatchCollectReqBean getEmulationData() {
		//准备参数
		BatchCollectReqBean ReqBean=new BatchCollectReqBean();
